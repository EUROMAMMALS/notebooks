...
--
-- Name: lu_species_determination_methods species_determination_methods_code; Type: DEFAULT; Schema: lu_tables; Owner: -
--

ALTER TABLE ONLY lu_tables.lu_species_determination_methods ALTER COLUMN species_determination_methods_code SET DEFAULT nextval('lu_tables.lu_species_determination_meth_species_determination_methods_seq'::regclass);
...
--
-- Name: lu_carcass_validity_code lu_carcass_validity_pk; Type: CONSTRAINT; Schema: lu_tables; Owner: -
--

ALTER TABLE ONLY lu_tables.lu_carcass_validity_code
    ADD CONSTRAINT lu_carcass_validity_pk PRIMARY KEY (carcass_validity_code);
...
--
-- Name: lu_death_date_accuracy lu_death_date_accuracy_pk; Type: CONSTRAINT; Schema: lu_tables; Owner: -
--

ALTER TABLE ONLY lu_tables.lu_death_date_accuracy
    ADD CONSTRAINT lu_death_date_accuracy_pk PRIMARY KEY (death_date_accuracy_code);
...
--
-- Name: lu_mortality lu_mortality_new_pkey; Type: CONSTRAINT; Schema: lu_tables; Owner: -
--

ALTER TABLE ONLY lu_tables.lu_mortality
    ADD CONSTRAINT lu_mortality_new_pkey PRIMARY KEY (id);
